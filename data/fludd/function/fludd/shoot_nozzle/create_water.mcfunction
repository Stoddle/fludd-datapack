summon item ~ ~2.2 ~ {Age:5920,PickupDelay:32767,Item:{id:"minecraft:knowledge_book",count:1,components:{"minecraft:item_model":"fludd:invisible_item"}},Tags:["newWaterChunk","waterChunk"]}
