...
execute if score @s fluddTurboSound matches 2 run playsound fludd:turbo_sprinkler player @a ~ ~ ~ 0.4 1
...
execute positioned ~ ~2 ~ run summon item ^ ^ ^-0.7 {Age:5920,PickupDelay:32767,Item:{id:"minecraft:knowledge_book",count:1,components:{"minecraft:item_model":"fludd:invisible_item"}},Tags:["newWaterChunk","waterChunk"]}
